    ...
    if ((value1)->isVector()) {
        ...
        if (value2->isBoolean()){
            ...
            for (int i = 0; i < size; i++){
                node = new Value((scalar ^ *(value1->vectorValue()->get(i)->booleanValue()))!= 0);
...
//        Vector<Value>* vectorValues = new Vector<Value>;
        ...
        if (node->isBoolean()){
            ...
            for (int i = 0; i < size2; i++){
                node = new Value((*(value2->vectorValue()->get(i)->booleanValue()) ^ *(value1->vectorValue()->get(i)->booleanValue()))!= 0);
                vectorValues->append(node);
            }
        ...
        Value* node;
        for (int i = 0; i < size2; i++){
            node = new Value((*(value2->vectorValue()->get(i)->booleanValue()) ^ scalar)!= 0);
            vectorValues->append(node);
        }
